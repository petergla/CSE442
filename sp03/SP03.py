...
def submisson(frame,labelg,assumpttion1,assumpttion2,assumpttion3,assumpttion4,radiobutton1,radiobutton2,radiobutton3,radiobutton4,radiobutton5,radiobutton6,radiobutton7):
    labelg.config(text='you failed')
    assumpttion1.config(bg='red')
    assumpttion2.config(bg='red')
    assumpttion3.config(bg='green')
    assumpttion4.config(bg='green')
...
# grade label
labelg = Label(root,text="current grade is ---",font="Helvetica 36 bold",fg='green')
...
# submit button
buttons = Button(frame,text="Submit Answer",command=lambda: submisson(frame,labelg,assumpttion1,assumpttion2,assumpttion3,assumpttion4,radiobutton1,radiobutton2,radiobutton3,radiobutton4,radiobutton5,radiobutton6,radiobutton7)).grid(row=12,column=0)
