...
labelq = Label(root,text="The question")
...
check1 = Checkbutton(root, text="Hip acts as a pivot point (no lifting off the bed)",variable=checkboxstatus1)
check2 = Checkbutton(root, text="Lower leg remains approximately perpendicular to upper leg",variable=checkboxstatus2)
check3 = Checkbutton(root, text="Forces are reasonably approximated using static analysis",variable=checkboxstatus3)
check4 = Checkbutton(root, text="Patient does not slide on the bed",variable=checkboxstatus4)
